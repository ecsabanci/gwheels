                ...
                <div className="mb-8">
                    <div className="prose prose-slate dark:prose-invert mb-8">
                        ...
                        <p className="text-base text-gray-600 dark:text-gray-400">
                            Burası, elektrikli araçlara tutkuyla bağlı bir topluluk ve bilgi merkezidir. Amacımız, elektrikli mobiliteye geçişi kolaylaştırmak, en son haberleri, incelemeleri ve ipuçlarını sizlerle paylaşmaktır.
                        </p>
